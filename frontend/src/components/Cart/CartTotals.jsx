            ...
            <Stack className="w-100 bg-gray-200-color border-0 p-4 rounded">
                ...
                </Stack>
                {
                    ...
                    <Stack direction="horizontal" className="align-items-start my-3">
                        ...
                        <Stack direction="vertical">
                            <span className="font-lato font-16 text-blue-400-color text-end">₹{shippingPrice}.00</span>
                        </Stack>
                    </Stack>
                }
                {
                    ...
                    <Stack direction="horizontal" className="align-items-start my-3">
                        ...
                        <Stack direction="vertical">
                            <span className="font-lato font-16 text-blue-400-color text-end">₹{gstPrice}.00</span>
                        </Stack>
                    </Stack>
                }
                <hr className="mb-4" />
                <Stack direction="horizontal" className="justify-content-between my-3">
                    ...
                    <span className="font-lato font-16 text-blue-400-color">₹{(location.pathname === "/shipping") ? grandTotal : totalPrice}.00</span>
                </Stack>
                <hr className="mb-4" />
